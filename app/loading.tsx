...
export default function PageLoading() {
  return (
    <div className="fixed w-full h-full text-center bg-dark-transparenty backdrop-filter backdrop-blur-md backdrop-brightness-125 flex justify-around items-center">
