...
export default function Book() {
  ...
  return (
    <div className="w-full flex justify-center">
      <form className="w-full max-w-4xl p-5 flex flex-col gap-3">
          ...
          <div className="flex flex-row gap-20 max-sm:gap-5 max-sm:flex-col justify-around">
            ...
            <div className="flex flex-col justify-center gap-2 w-full">
              <span className="flex flex-row max-sm:flex-col gap-3 max-sm:gap-0 h-10 max-sm:h-7">
                ...
                <div className="flex w-full gap-8 max-sm:gap-3">
                  <input
                  ...
                  />
                  <p className="w-fit float-right whitespace-nowrap text-2xl font-bold">
                    12 лв
                  </p>
                </div>
              </span>
